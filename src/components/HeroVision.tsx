...
// Hero section for the home page — flows normally above the other home
// sections; fades out as scrollP (driven by window scroll, in LayoutClient)
// approaches 1 so the orb reads clean once the presentation starts.
'use client';
